...
def main():
    ...
    args.store_name = '_'.join([args.dataset, args.arch, args.loss_type, args.train_rule, args.imb_type, str(args.imb_factor),'sam',str(args.rho) ,'sched',args.rho_schedule,'seed',str(args.seed),args.exp_str])
