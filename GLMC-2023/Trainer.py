...
class Trainer(object):
    def __init__(self, args, model=None,train_loader=None, val_loader=None,weighted_train_loader=None,per_class_num=[],log=None):
        ...
        if args.rho > 0:
            ...
            self.optimizer = SAM(base_optimizer=base_optimizer, rho=args.rho, params=model.parameters(), lr=args.lr, momentum=args.momentum, weight_decay=args.weight_decay)
            self.rho = args.rho
        else:    
        ...
        for epoch in range(self.start_epoch, self.epochs):
            ...
            for i, (inputs, targets) in enumerate(self.train_loader):
                ...
                if self.rho > 0: # Do second step of SAM
                    ...
                    loss = alpha * balance_loss + (1 - alpha) * rebalance_loss + self.contrast_weight * contrastive_loss # hardcoding contrast weight for analysis
