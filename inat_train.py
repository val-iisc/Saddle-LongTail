...
parser.add_argument('--dataset', default='inat_18', help='dataset setting')
...
parser.add_argument('--gpu', default=None, type=int,
                    help='GPU id to use.')
parser.add_argument('--root_log',type=str, default='log', help='location to store logs')
parser.add_argument('--root_model', type=str, default='checkpoint', help='location to store logs')
...
parser.add_argument('--multiprocessing_distributed', action='store_true',
                    help='use deterministic')
parser.add_argument('--data_path', default='inat_18', type=str, metavar='PATH',
...
def main_worker(gpu, ngpus_per_node, args):
    ...
    if args.dataset == 'inat_18':
      print("[INFORMATION] Extracting images from inat")
      dataset = iNa2018(args.distributed, root=args.data_path,
                              batch_size=args.batch_size, num_works=args.workers)
      cls_num_list = dataset.cls_num_list
      args.cls_num_list = dataset.cls_num_list
      print("[INFORMATION] Total number of classes ", len(cls_num_list))

      print("The class list for inat_18(initial 20) is ", dataset.cls_num_list[:20])
      print("The class list for inat_18(last 20) is ", dataset.cls_num_list[-20:])
    else:
