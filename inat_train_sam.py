...
def main_worker(gpu, ngpus_per_node, args):
    ...
    if args.dataset == 'inat_18':
      ...
      print("The class list for iNat-18 (initial 20) is ", dataset.cls_num_list[:20])
      print("The class list for iNat-18 (last 20) is ", dataset.cls_num_list[-20:])
    else:
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        for param_group in optimizer.param_groups:
            lr_1 = param_group['lr']
            rho_1 = param_group['rho']
        if args.log_results:
            wandb.log({'lr':lr_1, 'rho':rho_1, 'epoch':epoch})
